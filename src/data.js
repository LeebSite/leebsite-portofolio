...
export const listProyek = [
  {
    ...
    fullDescription: "Web Aplikasi untuk membantu kegiatan magang mahasiswa secara terintegrasi. Sistem ini mendukung pengelolaan data mahasiswa dan pembimbing, pencatatan aktivitas magang melalui logbook, serta pengunggahan dan pengelolaan laporan magang secara digital.",
    borderColor: "#3B82F6",
  ...
  },
  {
    ...
    fullDescription: "Program ini dirancang untuk melatih KNN dalam menganalisa citra menggunakan ekstraksi Fitur GLCM yang mana dapat diterapkan dalam klasifikasi dari bentuk citra tanda tangan. Sehingga program ini dapat diterapkan dalam melakukan klasifikasi citra tanda tangan lain dengan data yang berbeda pula.",
    borderColor: "#10B981",
  ...
  },
  {
    ...
    fullDescription: "Website portofolio Masjid Raudhatul Jannah ini dibuat untuk mengimplementasikan pemahaman saya dalam membuat website portfolio dan perancangan frontend web development. Website ini berisikan informasi seputar Masjid Raudhatul Jannah yang berada di Pekanbaru. Dibangung menggunakan HTML, Bootstrap, dan JavaScript dengan UI yang Modern",
    borderColor: "#3B82F6",
    gradient: "linear-gradient(145deg, #3B82F6, #000)",
    url: "https://github.com/LeebSite",
    dad: "500",
