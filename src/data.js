...
export const listProyek = [
  {
    ...
    subtitle: "Sistem End-to-End ML untuk Kesehatan dengan React & FastAPI...",
    fullDescription: "Membangun aplikasi web full-stack untuk prediksi risiko stroke, mengintegrasikan frontend React dengan backend FastAPI asinkron. Mengembangkan pipeline machine learning menggunakan XGBoost dan K-Means untuk segmentasi pasien. Mengimplementasikan Explainable AI (XAI) menggunakan SHAP dan containerization dengan Docker.",
    borderColor: "#3B82F6",
  ...
  },
  {
    ...
    subtitle: "Sistem Kasir Digital & Manajemen Keuangan UMKM...",
    fullDescription: "Mengembangkan aplikasi Point of Sales (POS) komprehensif dan pelacakan keuangan berbasis web yang disesuaikan khusus untuk alur kerja operasional UMKM. Mengoptimalkan pencatatan transaksi harian, pelacakan inventaris, dan pelaporan pendapatan untuk meningkatkan visibilitas keuangan.",
    borderColor: "#10B981",
